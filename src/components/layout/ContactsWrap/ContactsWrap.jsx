        ...
        <section className={s.contactsWrap}>
            {isClient && <Container>
                <div className={s.top}>
                    ...
                    <p>{t('contactsWrap.description')}</p>
                </div>
                ...
                <div className={s.wrap}>
                    ...
                    <div className={s.box}>
                        ...
                        <div className={s.socs}>
                            <a target="_blank" href="#"><img src="/img/social-icon-fb.svg" alt="Facebook" /></a>
                            <a target="_blank" href="#"><img src="/img/social-icon-tw.svg" alt="Twitter" /></a>
                            <a target="_blank" href="#"><img src="/img/social-icon-inst.svg" alt="Instagram" /></a>
                            <a target="_blank" href="#"><img src="/img/social-icon-in.svg" alt="LinkedIn" /></a>
                        </div>
                    </div>
                </div>
            </Container>}
